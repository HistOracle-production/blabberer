...
from blabber.face_detect import detect_face_crop
from blabber.shapes import SHAPE_DEFS, PROMPT_TEMPLATE
...
def _get_reference_dir() -> Path:
    ...
    return Path(str(files("blabber"))) / "reference"
...
def _call_openrouter(
    ...
    headers = {
        ...
        "HTTP-Referer": "https://github.com/historacle-ai/blabber",
        "X-Title": "Blabber Lip-Sync Sprite Generator",
    }
...
def generate_sprites(
    ...
    x_path = output_path / "shape_X.png"
    face_crop.save(x_path, "PNG")
