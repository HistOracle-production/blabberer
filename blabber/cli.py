"""
Command-line interface for Blabber.

Usage:
    blabber generate <image_path> [options]
"""

import argparse
import sys

from blabber import __version__
...
def cmd_generate(args: argparse.Namespace) -> None:
    ...
    from blabber.postprocess import full_postprocess
...
def main() -> None:
    ...
    parser.add_argument(
        "--version", action="version", version=f"blabber {__version__}"
    )
